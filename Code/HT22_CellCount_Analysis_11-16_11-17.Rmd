...
Since a statistically significant number of counts were perfromed for this condition, we will do a two sample t test to figure out the differences between them.
