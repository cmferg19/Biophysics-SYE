...
counts$Count_trial <- recode(counts$Count_trial, "1" = 'Before Exposure', "2" = 'After Exposure')
```
...
counts$Condition <- recode(counts$Condition, EMF_1 = 'B-Field', EMF_2 = 'B-Field', Control = 'Control')
...
```
Now we will make a scatterplot with this data and seperate it based on the count
