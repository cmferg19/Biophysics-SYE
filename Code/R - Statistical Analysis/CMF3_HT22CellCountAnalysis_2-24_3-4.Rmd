...
full_media_plt <- ggplot(mean_counts, aes(Trial_Day, meancounts, color = Condition, group = Condition))+
     geom_point()+
     geom_line()+
...
ggsave(filename = "full_media_plt_sem2.jpg",
       plot = full_media_plt,
       width = 7,
       height = 4)
```
...
mean_counts["Slope"] <- c(NA, -0.1145833, 0.06944444, 0.7708333, 0.7465278, 1.347222, 1.772569, NA, 0.07835145,-0.04876812, 0.8211111, 0.4045139, 0.8576389, 2.258681)
