---
title: "CMF5 HT22 cell count analysis 3-10 to 3-17"
output: html_notebook
---

This code is designed to analyze the cell count data from the forth experimental trial after putting mouse hippocampal cells in the EMF for 30 mins.  The goal of this trial is to measure survivalbility of these cells and optimize the magnetic field exposure protocol.
...
counts <- read.csv(here("Data", "CMF5_HT22Cells_3-10_3-17.csv"),stringsAsFactors = TRUE)
...
mean_counts["Slope"] <- c(NA,1.354167, 5.645833, 7.934028, 5.446181, -21.94097, NA, NA,2.324653, 6.845486, 9.145833, 3.336806, -20.90799, NA)
